...
//ตัว redirect ใช้เช็คว่ามีการ login เข้ามาไหม ถ้าไม่ก็ให้ redirect ไปหน้า login
...
useEffect(() => {
  ...
  return (
    <Container>
        {/* ตรงนี้ส่ง prop ไปที่ navbar ให้แสดงแค่ logout */}
                    ...
                    <div>
                        {postData && postData.length > 0 ? (
                            postData.map(val=>(
                                ...
                                <div className='mt-5'>
                                    {/* // ด้านหลังเป็นการทำ dynamic routing ให้หน้าเว็บไม่โหลด และนำทางไป url นั้น */}
